...
### Step 2: Copy Files
Extract all files to: `C:\xampp\htdocs\registration_project\`
...
Open: http://localhost/registration_project/test_connection.php

### Step 5: Start Using
Open: http://localhost/registration_project/
...
- [ ] Files in `C:\xampp\htdocs\registration_project\`
...
### "Not Found" Error
**Solution:** 
- Make sure files are in `C:\xampp\htdocs\registration_project\`
- NOT in a subfolder
...
### Login
1. Go to http://localhost/registration_project/login.php

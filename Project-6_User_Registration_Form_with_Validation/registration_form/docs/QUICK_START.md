...
**Test 1: Connection**
Visit: `http://localhost/registration_form_fixed/test_connection.php`
- Should show all green checkmarks ✅
- If not, see error messages for solutions

**Test 2: Registration Form**
Visit: `http://localhost/registration_form_fixed/`
- Fill in the form
...
3. Run: `http://localhost/registration_form_fixed/test_connection.php`

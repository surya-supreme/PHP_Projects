...
2. Navigate to: **http://localhost/registration_form/**
...
- Make sure all files are in: `C:\xampp\htdocs\registration_form\`
...
2. If another application is using port 80, change it:
   ...
   - Restart Apache
   - Access via: `http://localhost:8080/registration_form/`

### Solution 4: Check URL
- Correct URL: `http://localhost/registration_form/`
- NOT: `http://localhost/registration_form/index.html`
- NOT: `file:///C:/xampp/htdocs/registration_form/`
...
1. Click **"Login here"** or go to: `http://localhost/registration_form/login.php`
...
- [ ] Files in htdocs/registration_form/
